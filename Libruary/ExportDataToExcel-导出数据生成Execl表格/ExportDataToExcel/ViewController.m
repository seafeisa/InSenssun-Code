...
//    LibXL.framework 文件较大，不能上传，下载了拖进项目即可
...
-(void)clickBtn{
    ...
    NSArray *activittyItems = @[docu];
    
    
    
    UIActivityViewController * activityVC = [[UIActivityViewController alloc] initWithActivityItems:activittyItems applicationActivities:nil];
