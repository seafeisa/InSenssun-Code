...
- (void)reloadDataWithModel:(LZCartModel*)model {
    [self.lzImageView sd_setImageWithURL:[NSURL URLWithString:model.image] placeholderImage:[UIImage imageNamed:@"img_fenlei.png"]];
...
-(void)setupMainView {
    ...
    priceLabel.frame = CGRectMake(nameLabel.left, sizeLabel.bottom + 5, width, 20);
