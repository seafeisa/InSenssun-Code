...
@interface Mine_Things_ViewController ()<UITableViewDelegate, UITableViewDataSource>{
}
...
@implementation Mine_Things_ViewController
...
- (void)getData{
    ...
    [[APPNetAPIManager sharedManager]request_Waitgot_WithId:[Login_Total curLoginUser].id andBlock:^(id data, NSError *error) {
