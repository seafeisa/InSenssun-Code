...
@interface Member_ViewController ()<UITableViewDelegate, UITableViewDataSource>{
}
...
- (void)viewDidLoad {
    ...
    _myTableView = ({
        ...
        [tableView registerNib:[UINib nibWithNibName:@"Member_TableViewCell" bundle:nil] forCellReuseIdentifier:@"Member_TableViewCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    Member_TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Member_TableViewCell" forIndexPath:indexPath];
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.sure_pay_Block = ^(BOOL isWechat) {
        if (isWechat == YES) {
            [self.view beginLoading];
//            [[APPNetAPIManager sharedManager]request_wxPay_WithTotal_price:self.totalPrice out_trade_no:self.Trade_No andBlock:^(id data, NSError *error) {
...
//            }];
            ...
            [self.view beginLoading];
//            [[APPNetAPIManager sharedManager]request_alipaySign_WithTotal_price:self.totalPrice out_trade_no:self.Trade_No andBlock:^(id data, NSError *error) {
//                [self.view endLoading];
//                if (data) {
