...
@interface WaitMoney_ViewController ()<UITableViewDelegate, UITableViewDataSource>{
}
...
@implementation WaitMoney_ViewController
...
- (void)getData{
    ...
    [[APPNetAPIManager sharedManager]request_Waitmoney_WithId:[Login_Total curLoginUser].id andBlock:^(id data, NSError *error) {
