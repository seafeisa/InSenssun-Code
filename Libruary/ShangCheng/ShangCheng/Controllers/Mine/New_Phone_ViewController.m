...
@interface New_Phone_ViewController ()<UITableViewDelegate, UITableViewDataSource>{
    BOOL timeStart;
}
...
@implementation New_Phone_ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.nextStep_Block = ^(NSString *phone, NSString *code) {
        [self.view endEditing:YES];
        [self.view beginLoading];
        [[APPNetAPIManager sharedManager]request_changenew_WithCode:code phone:phone member_id:[Login_Total curLoginUser].id andBlock:^(id data, NSError *error) {
            [self.view endLoading];
            if (data) {
