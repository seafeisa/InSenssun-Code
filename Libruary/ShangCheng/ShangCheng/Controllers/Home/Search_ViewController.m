...
@interface Search_ViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>{
...
- (void)viewDidLoad {
    ...
    layout.itemSize = CGSizeMake((kScreen_Width - 15) / 2, 200);
    layout.minimumInteritemSpacing = 5;
    layout.minimumLineSpacing = 5; //上下的间距 可以设置0看下效果
    layout.sectionInset = UIEdgeInsetsMake(0.f, 5, 0.f, 5);
...
- (void)getGoods {
    ...
    [[APPNetAPIManager sharedManager]request_searchgoods_WithContent:text_field.text andBlock:^(id data, NSError *error) {
